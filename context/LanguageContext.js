...
const translations = {
  en: {
    ...
    "Overview of your voter list application":
      "Overview of your voter list application",
    "Total Sessions": "Total Voter Lists",
    "Printed Slips": "Printed Slips",
    "Total Users": "Total Users",
    "Quick Actions": "Quick Actions",
    "Upload New PDF": "Upload Voter List",
    "View All Sessions": "View All Voter Lists",
    "Manage Users": "Manage Users",
    "View Statistics": "View Statistics",
    "Recent Sessions": "Recent Voter Lists",
    "View all": "View all",
    voters: "voters",
    pages: "pages",
    "No sessions yet. Upload a PDF to get started.":
      "No voter lists yet. Upload a voter list to get started.",
  ...
  hi: {
    ...
    Dashboard: "डैशबोर्ड",
    Sessions: "मतदाता सूचियां",
    Upload: "मतदाता सूची अपलोड करें",
    Users: "उपयोगकर्ता",
    ...
    Session: "मतदाता सूची",
    "All Sessions": "सभी मतदाता सूचियां",
    ...
    "Total Sessions": "कुल मतदाता सूचियां",
    "Printed Slips": "प्रिंटेड स्लिप",
    "Total Users": "कुल उपयोगकर्ता",
    "Quick Actions": "त्वरित कार्रवाई",
    "Upload New PDF": "मतदाता सूची अपलोड करें",
    "View All Sessions": "सभी मतदाता सूचियां देखें",
    "Manage Users": "उपयोगकर्ता प्रबंधित करें",
    "View Statistics": "आंकड़े देखें",
    "Recent Sessions": "हाल की मतदाता सूचियां",
    "View all": "सभी देखें",
    voters: "मतदाता",
    pages: "पृष्ठ",
    "No sessions yet. Upload a PDF to get started.":
      "अभी तक कोई मतदाता सूची नहीं है। शुरू करने के लिए एक मतदाता सूची अपलोड करें।",
  ...
  bn: {
    ...
    Sessions: "ভোটার তালিকা",
    Upload: "ভোটার তালিকা আপলোড",
    Users: "ব্যবহারকারী",
    "API Keys": "এপিআই কী",
    Stats: "পরিসংখ্যান",
    Agent: "এজেন্ট",
    ...
    Session: "ভোটার তালিকা",
    "All Sessions": "সমস্ত ভোটার তালিকা",
    ...
    "Total Sessions": "মোট ভোটার তালিকা",
    "Printed Slips": "প্রিন্টেড স্লিপ",
    "Total Users": "মোট ব্যবহারকারী",
    "Quick Actions": "দ্রুত কর্ম",
    "Upload New PDF": "ভোটার তালিকা আপলোড করুন",
    "View All Sessions": "সমস্ত ভোটার তালিকা দেখুন",
    "Manage Users": "ব্যবহারকারী পরিচালনা করুন",
    "View Statistics": "পরিসংখ্যান দেখুন",
    "Recent Sessions": "সাম্প্রতিক ভোটার তালিকা",
    "View all": "সব দেখুন",
    voters: "ভোটার",
    pages: "পৃষ্ঠা",
    "No sessions yet. Upload a PDF to get started.":
      "এখনও কোন ভোটার তালিকা নেই। শুরু করতে একটি ভোটার তালিকা আপলোড করুন।",
